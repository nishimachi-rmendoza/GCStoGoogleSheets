function importCSVFromGCS() {
  ...
  var sheetName = 'Main'; // The name of the sheet where you want to import the data
  ...
  // This is so that you can know exactly when the last sync was directly from the sheet
